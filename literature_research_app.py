...
"""
Author: Bernhard Gotthart - 03.11.2023
"""

MAX_ITER = 5

WELCOME_MESSAGE = f"""Literature Research Agent Team 📖🔍🤓🤖
\n\n
We can help you with your research. We can also create charts regarding the domains, topics etc. \n\n
This might be helpful for you Bachelor's or Master's Thesis 😉
"""
...
async def setup_agent():
    ...
    await cl.Message(content=f"Start searching with code interpreter").send()
